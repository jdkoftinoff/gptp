/*
 *  linux/include/net/gptp/gptp_defs.h
 *
...
#ifndef _GPTP_DEFS_H_
#define _GPTP_DEFS_H_
 ...
 */
#define GPTP_RTC_MANTISSA_BITS   (4)
#define GPTP_RTC_INC_MIN ( 4)
#define GPTP_RTC_INC_MAX (10)
#define GPTP_RTC_FRACTION_BITS  (27)
typedef struct {
	uint32_t mantissa;
	uint32_t fraction;
} RtcIncrement;
...
#define GPTP_TIMER_PRESCALER_BITS  (12)
#define GPTP_TIMER_DIVIDER_BITS    (10)
...
#define DEFAULT_E2E_COEFF_P  (0xFFF00000)
#define DEFAULT_E2E_COEFF_I  (0xFFF00000)
